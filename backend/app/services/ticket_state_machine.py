...
def allowed_status_targets(
    ...
    if effective_role is UserRole.AGENT and ticket.assignee_id != actor.id:
        return set()
    ...
    if ticket.status is TicketStatus.RESOLVED and effective_role is UserRole.ADMIN:
